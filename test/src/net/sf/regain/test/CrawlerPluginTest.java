...
public class CrawlerPluginTest extends TestCase {
  ...
  public void testAllEventsWorking() {
    try {
      pluginManager.eventAcceptURL(null, null);
    ...
    try {
      pluginManager.eventAfterPrepare(null, null);
    } catch (IllegalArgumentException e) {
    }
    try {
      pluginManager.eventBeforePrepare(null, null);
    } catch (IllegalArgumentException e) {
    }
    try {
      pluginManager.eventCreateIndexEntry(null, null);
    } catch (IllegalArgumentException e) {
    }
    try {
      pluginManager.eventDeleteIndexEntry(null, null);
    } catch (IllegalArgumentException e) {
    }
    try {
      pluginManager.eventStartCrawling(null);
    } catch (IllegalArgumentException e) {
    }
    try {
      pluginManager.eventFinishCrawling(null);
    } catch (IllegalArgumentException e) {
    }
  }
